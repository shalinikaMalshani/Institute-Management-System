...
export default class HomeStudent extends React.Component{
    ...
    retrieveStudents(){
        axios.get("localhost:8091/onlineStudent/onlineStudents")
        .then(res=>{
        if(res.data.success){
        this.setState({
                    ...
                    <div class="info_wrapper">
                        ...
                        <div class="login_info">
                             <ul class="d-flex">
                                ...
                                <a href={`/gets/${this.state.userId}`}><img src={this.state.userProfile} alt="" style={{"width":"45px","borderRadius":" 50%","height":" 45px","objectFit":" cover","marginRight":"20px"}}></img></a><span style={{"color":"white","marginRight":"20px"}}>{this.state.username}</span>
