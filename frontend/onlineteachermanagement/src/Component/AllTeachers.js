                 ...
                 <div class="col-sm-12 col-md-8 col-lg-8">
                    <div class="intro_text">
                        ...
                        <div class="pages_links">
                            <a href="#" title="">Home</a>
                            <a href="#" title="" class="active">Our Teachers</a>
                        </div>
                    </div>
                </div>              
...
<div class="single-wrappe col-12 col-sm-6 col-md-4 col-lg-4" key={index}>
                
                <div class="team-single-item">
                    <figure>
                        <div class="member-img">
                            <div class="teachars_pro">
                                <img src={teachers.photo} alt="member img" class="img-fluid"/>
                            </div>
                        </div>
                        <figcaption>
...
<section id="scroll-top" class="scroll-top">
    ...
    <script src="js/page-smoth-scroll.js"></script>        
