...
export default class OnlineStudentProfile extends Component{
    ...
    render(){
        ...
        return(
            <div>
            <div className="container"  id= 'print'  style={{padding:"40px",marginLeft:"450px",marginTop:"50px", marginBottom:"50px",marginRight:"300px",width:"50%", backgroundColor:"white", height:"900px"}}>
              {/* <div className="logo">
                ...
                <dl  className="row col-sm-12" style={{paddingLeft:"20%"}}>
                   ...
                   <a className="btn btn-warning"   style={{marginLeft:"100px", marginTop:"-70px", height:"40px",width:"150px"}}  href={`/onlineUpdate/${this.props.match.params.id}`}>
                    ...
                    <button className="btn btn-danger" style={{marginLeft:"300px", marginTop:"-120px", height:"40px",width:"150px"}} onClick={this.print}>
